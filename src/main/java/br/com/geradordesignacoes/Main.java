...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                designacao.getParticipante(TipoParticipacao.RESPONSAVEL)
        );

        System.out.println(
                designacao.getParticipante(TipoParticipacao.AJUDANTE)
        );
...
// ============================
        ...
        Parte demonstracaoEscala = new Parte(
                "Primeira Conversa",
                TipoParte.DEMONSTRACAO,
                Privilegio.BATIZADO,
                true,
        ...
        List<Parte> partesTeste = List.of(
                leituraEscala,
                demonstracaoEscala
        );
        ...
        GeradorEscala geradorEscala = new GeradorEscala(
                new RegrasService()
        );
        ...
        for (Designacao d : resultado.getDesignacoes()) {
            ...
            System.out.println("-------------------------");
            System.out.println("Parte: " + d.getParte().getNome());
            System.out.println("Responsável: "
                    + d.getResponsavel().getNome());

            if (d.getAjudante() != null) {
                System.out.println(
                        "Ajudante: "
                                + d.getAjudante().getNome()
                );
            }
        }
    }
